...
public class Register extends AppCompatActivity {
    ...
    private String coupon_val, select_modal, seleced_code;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> categoriesAdapter = new ArrayAdapter<String>(Register.this, android.R.layout.simple_spinner_item, codeList);
...
//                codeList.get(ite)
        ...
        email_ed.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                if (!hasFocus) {
                    if (!Patterns.EMAIL_ADDRESS.matcher(email_ed.getText().toString()).matches()) {
        ...
        call.enqueue(new Callback<InfoModalModel>() {
            ...
            public void onResponse(Call<InfoModalModel> call, Response<InfoModalModel> response) {
                if (response.body().getSuccess()) {
                    ...
                    ArrayAdapter<String> categoriesAdapter = new ArrayAdapter<String>(Register.this, android.R.layout.simple_spinner_item, list);
    ...
    public void onRadioBaqqaClicked(View view) {
        ...
        switch (id) {
            case R.id.goldBaqqa_btn_id:
                baqqa_type = 1;
                baqqaVal_txtV.setText("400");
                break;
            case R.id.silverBaqqa_btn_id:
                baqqa_type = 2;
                baqqaVal_txtV.setText("250");
                break;
        }
    }
    ...
    public void setBaqqaBositives() {
        Intent intent = new Intent(Register.this, SelectBaqqa.class);
    ...
    public void register() {
        if (!FUtilsValidation.isEmpty(fullName_ed, getString(R.string.required))
            ...
            Intent intent = new Intent(Register.this, PaymentMethod.class);
...
//            coupon_val = discountCode_ed.getText().toString();
//
//            //  get choice Baqqa from RadioButtons
//            ApiInterface apiInterface = ApiClient.getClient().create(ApiInterface.class);
//            Call<RegisterResponseModel> call = apiInterface.register(fullName, email, phone_Num, user_identity, password, car_Num, car_Model, car_Type, register_type, baqqa_type, coupon_val, latitude, longtitude, token, LogIn.selected_lang);
...
//
//                    } else {
//                        Toast.makeText(Register.this, getResources().getString(R.string.data_used_before), Toast.LENGTH_SHORT).show();
//                    }
//                }
//
//                @Override
...
//            });
    ...
    public void registerType(View view) {
        int id = view.getId();
        switch (id) {
            case R.id.as_user_rb_id:
                register_type = 1;
                asUser_layout_data.setVisibility(View.VISIBLE);
                break;
            case R.id.as_empolyer_rb_id:
                register_type = 2;
                asUser_layout_data.setVisibility(View.GONE);
                break;
        }
